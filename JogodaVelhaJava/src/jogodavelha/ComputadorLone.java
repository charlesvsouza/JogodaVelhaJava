...
public class ComputadorLone extends Jogador{
	...
	*/
    ...
    public ComputadorLone(int jogador){
        super(jogador);
        System.out.println("O computador nivel 2 está On Line!");
        System.out.println("Você está jogando com o R2D2!");       
    }  
    @Override
