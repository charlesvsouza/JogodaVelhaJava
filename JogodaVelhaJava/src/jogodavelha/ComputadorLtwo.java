...
public class ComputadorLtwo extends Jogador{
	...
	*/
    ...
    public ComputadorLtwo(int jogador){
        super(jogador);
        System.out.println("O computador nivel 3 está On Line!");
        System.out.println("Você está jogando com o C3PO!");       
    }  
    @Override
